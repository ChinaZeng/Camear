...
public class Camera2Helper2 {
    ...
    public Camera2Helper2(AutoFitTextureView mTextureView, Activity activity) {
...
//                    Log.d(TAG, mFile.toString());
                ...
                if (null != output) {
                    try {
                        ...
                        if(mOnTakePictureListener!=null){
                            mOnTakePictureListener.onTakePicture(savaOk,mFile);
                        }
                    } catch (IOException e) {
                        e.printStackTrace();
                    }
    ...
    public interface  OnTakePictureListener{
        void onTakePicture(boolean isOk,File file);
    }
